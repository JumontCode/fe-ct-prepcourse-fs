...
function sumarLikesDeUsuario(objetoUsuario) {
   ...
   for(var i = 0; i < objetoUsuario.posts.length; i++){
      sumarLikes = objetoUsuario.posts[i].likes + sumarLikes;
   }
   return sumarLikes;
}
...
function agregarMetodoCalculoDescuento(objetoProducto) {
   ...
   function (){
      var calcDescuento = objetoProducto.precio * objetoProducto.porcentajeDeDescuento;
      objetoProducto.precio = objetoProducto.precio - calcDescuento;
