...
function incrementarPorUno(array) {
   ...
   var numMasUno = array.map(function(x){return x + 1})
   array = numMasUno;
   return array;
}
...
function agregarNumeros(arrayOfNums) {
   ...
   var contador = 0;
   var resultado = arrayOfNums.reduce((num1,num2)=>num1 + num2, contador);
...
function empiezaConNueve(num) {
   ...
   var n1 = num.toString().split('');

   var n = n1.filter(i => i[0] === '9');
...
function todosIguales(array) {
   ...
   for(var i = 0; i < array.length; i++){
    ...
    else if(num !== array[i]){return false;}}
}
...
function mesesDelAño(array) {
   ...
   var findEnero, findMarzo, findNoviembre;
   ...
   return findEnero===true&&findMarzo===true&&findNoviembre===true?Array2:"No se encontraron los meses pedidos";
   }
