...
function esVocal(letra) {
   // Escribe una función que ral == "e" || esVocal == "i" || esVocal == "o" || esVocal == "u")
   // {console.log("Es vocal");}
   // else {console.log("Dato incorrecto");}eciba una letra y, si es una vocal, muestre el mensaje “Es vocal”.
